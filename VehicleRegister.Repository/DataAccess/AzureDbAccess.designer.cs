...
namespace VehicleRegister.Repository.DataAccess
{
	...
	public partial class Vehicle : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _VehicleService;
		...
		private EntityRef<VehicleService> _VehicleService1;
    ...
    partial void OnVehicleServiceChanging(System.Nullable<int> value);
    partial void OnVehicleServiceChanged();
    ...
    partial void OnServiceHistoryChanged();
		...
		public Vehicle()
		{
			...
			this._VehicleService1 = default(EntityRef<VehicleService>);
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_VehicleService", DbType="Int")]
		public System.Nullable<int> VehicleService
		{
			get
			{
			...
			set
			{
				if ((this._VehicleService != value))
				{
					if (this._VehicleService1.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnVehicleServiceChanging(value);
					this.SendPropertyChanging();
					this._VehicleService = value;
					this.SendPropertyChanged("VehicleService");
					this.OnVehicleServiceChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="VehicleService_Vehicle", Storage="_VehicleService1", ThisKey="VehicleService", OtherKey="VehicleServiceId", IsForeignKey=true)]
		public VehicleService VehicleService1
		{
			get
			{
				return this._VehicleService1.Entity;
			}
			set
			{
				VehicleService previousValue = this._VehicleService1.Entity;
				if (((previousValue != value) 
							|| (this._VehicleService1.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._VehicleService1.Entity = null;
						previousValue.Vehicles.Remove(this);
					}
					this._VehicleService1.Entity = value;
					if ((value != null))
					{
						value.Vehicles.Add(this);
						this._VehicleService = value.VehicleServiceId;
					}
					else
					{
						this._VehicleService = default(Nullable<int>);
					}
					this.SendPropertyChanged("VehicleService1");
				}
			}
		}
    ...
    partial void OnIsServiceCompletedChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="VehicleService_Vehicle", Storage="_Vehicles", ThisKey="VehicleServiceId", OtherKey="VehicleService")]
		...
		{
			this.SendPropertyChanging();
			entity.VehicleService1 = this;
		}
		
		private void detach_Vehicles(Vehicle entity)
		{
			this.SendPropertyChanging();
			entity.VehicleService1 = null;
		}
	}
}
